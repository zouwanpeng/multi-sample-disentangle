...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_file', default='E:/yan0/Papers/SpaMosaic-main/SpaMosaic-main/data/E15/E15_adata_atac.h5ad')
    ...
    x = PCA(n_components=200, random_state=42).fit_transform(adata.X).astype('float64')
    # x = adata.X.astype('float64')  # count matrix
    loc = adata.obsm['spatial'].astype('float64')  # location information
    peak_name = adata.var_names.astype('U30')  # peak names
